The file "上交所公司名单201712.txt" contains the codes of all companies listed on the Shanghai Stock Exchange as of the close of trading on December 31, 2017.

The code file "上交所抓取命令.py" performs the following tasks:
...
The data recorded in the text file is then imported into the "全部上交所公告2017年度.xlsx" file, allowing for batch copying of these URLs. These download URLs are subsequently batch-imported into a specialized download tool to enable bulk downloading of company announcements.